import{aP as c,Q as o,S as v,ae as i,U as n,ac as e,aQ as d,C as l}from"./framework-f20be66a.js";const r={},u=n("h1",{id:"总结",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#总结","aria-hidden":"true"},"#"),e(" 总结")],-1),m=d(`<p>leetcode 调试工具，后期考虑做成idea插件卖钱</p><p>滑动窗口问题： 适用于子数组子序列的问题</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 滑动窗口算法框架 */
