import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as r,e as i,a as n,b as e,f as d}from"./app-8ba411b2.js";const v={},u=n("h1",{id:"总结",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#总结","aria-hidden":"true"},"#"),e(" 总结")],-1),m=d(`<p>leetcode 调试工具，后期考虑做成idea插件卖钱</p><p>滑动窗口问题： 适用于子数组子序列的问题</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 滑动窗口算法框架 */
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>::: slot [page-bottom]</p><p>插槽内容，会被作为 markdown 渲染，你也可以使用 Vue 组件。</p><p>:::</p>`,15);function _(h,f){const a=l("DynamicTable"),t=l("counter"),s=l("ExternalLinkIcon");return c(),r("div",null,[u,i(a,{name:"npm"}),i(t),m,n("p",null,[e("** 二叉树题目的递归解法可以分两类思路，第一类是遍历一遍二叉树得出答案，第二类是通过分解问题计算出答案，这两类思路分别对应着 "),n("a",b,[e("回溯算法核心框架"),i(s)]),e(" 和 "),n("a",p,[e("动态规划核心框架"),i(s)]),e("** 。")]),g])}const q=o(v,[["render",_],["__file","-1.html.vue"]]);export{q as default};
